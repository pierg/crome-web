            ...
            <>
                ...
                >
                    ...
                    <div className="console">
                        <textarea className="bg-blueGray-800 no-resize text-white w-full border-0" ref={this.consoleRef} rows={5} readOnly value={this.props.customText || this.props.text}/>
                    </div>
                </nav>
            </>
        );
