...
function ComponentEdit(props) {
  ...
  function changeParameter(
    ...
    const contractTypeIndex = contractType
      ? component.contract[contractType][index]
      : false;
  ...
  return (
    <>
      ...
      <div className="modal-body justify-content-center">
        ...
        />
        <div>
          <label htmlFor="inputs" className="title title-up">
            Inputs
          </label>
          <Input
            type="text"
            ...
            onChange={changeParameter}
          />
          <label htmlFor="outputs" className="title title-up">
            Outputs
          </label>
          <Input
            type="text"
        ...
        <div className="flex flex-col w-full">
          ...
          <div className="flex w-full justify-between">
            ...
            <Button
              ...
              disabled={component.contract.guarantees.length === 0}
