            ...
            <div className="flex flex-wrap w-full">
              ...
              <div className="flex flex-col flex-wrap w-full">
                <div className="relative w-full pr-4 mt-2 mb-2 max-w-full flex-grow flex-1">
                  <span className="font-bold text-md uppercase text-blueGray-700">
                    Children :{" "}
                  </span>
                  <span
                    className="text-md text-blueGray-700"
                    dangerouslySetInnerHTML={{
                      __html: "generated by " + props.nodeChildren,
                    }}
                  ></span>
                  <br />
                  {props.nodeParent && (
                    <>
                      ...
                      <span
                        className="text-md text-blueGray-700"
                        dangerouslySetInnerHTML={{
                          __html: "participing in " + props.nodeParent,
                        }}
                      ></span>
                    </>
                  )}
