import "_docs/components/CodeSnippet.js"
import "_docs/components/Footer.js"
import "_docs/components/HeaderVideoTitle.js"
...
import "_docs/views/Components.js"
        ...
        <Switch>
          ...
          {routes.map((prop, key) => {
            return prop.sections.map((sectionProp, sectionKey) => {
              return sectionProp.components.map((componentProp, componentKey) => {
                return (
                  <Route
                    key={key}
                      ...
                      <div className="bg-white min-h-screen">
                        ...
                        >
                          ...
                          <ul className="fixed left-auto right-0 pr-4 z-2">
                            {componentProp.components.map((exampleProp, exampleKey) => {
                              return (
                          ...
                          {componentProp.components.map((exampleProp, exampleKey) => {
                            return (
                              <div key={exampleKey + "example"} className="mb-16">
                                <CodeSnippet
                                  {...exampleProp}
                                  componentName={
                                    <h2
                                      className="text-xl font-bold mt-4 ct-component-name-title px-4"
                                      id={
                                        prop.id +
                                        "-" +
                                        sectionProp.id +
