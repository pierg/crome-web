...
export default function NavbarComponents() {
  ...
  return (
    <>
      <nav className="fixed w-full shadow-lg bg-white shadow-lg flex flex-wrap items-center justify-between px-2 py-3 z-9999">
        <div className="w-full px-4 mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            ...
            >
              <i className="text-blueGray-800 fas fa-bars"></i>
            </button>
          </div>
          <div
            className={
            ...
            <ul className="flex flex-col lg:flex-row list-none mr-auto">
              <li className="flex items-center">
                <Link
                  ...
                  className="hover:opacity-75 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold transition-all duration-150 ease-in-out text-blueGray-800"
                >
                  Documentation
                </Link>
              </li>
            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="flex items-center">
                <a
                  ...
                  href="#pablo"
                >
                  <i className="text-blueGray-500 fab fa-twitter text-lg leading-lg " />
              ...
              <li className="flex items-center">
                <a
                  ...
                  href="#pablo"
                >
                  <i className="text-blueGray-500 fab fa-github text-lg leading-lg " />
                  <span className="lg:hidden inline-block ml-2">Star</span>
                </a>
              </li>
              <li className="flex items-center">
                <button
                  className="text-xs px-4 py-2 shadow hover:shadow-md text-blueGray-800 bg-blueGray-200 border-blueGray-200 active:bg-blueGray-300 active:border-blueGray-300 rounded outline-none focus:outline-none align-middle transition-all duration-150 ease-in-out uppercase border border-solid font-bold mr-2"
                  type="button"
                >
                  Check FREE
                </button>
