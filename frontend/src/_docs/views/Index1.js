...
export default function Index() {
  ...
  return (
    <>
      <div className="md:h-screen bg-pink-900 w-full text-white overflow-hidden">
        <div className="flex flex-wrap items-center h-full justify-center">
          <div className="w-full lg:w-5/12 px-4 md:px-10 lg:px-20">
            ...
            <button
              className="text-blueGray-200 border-blueGray-200 active:bg-blueGray-300 active:border-blueGray-300 active:text-blueGray-800 text-sm px-6 py-3 shadow hover:shadow-lg bg-transparent border border-solid font-normal rounded outline-none focus:outline-none align-middle transition-all duration-150 ease-in-out uppercase font-bold"
              type="button"
            >
              Download FREE
            </button>
          ...
          {/*<div className="hidden w-full h-full lg:w-7/12 lg:block">
            <img className="w-full" src=leftImage} alt="..." />
          </div>*/}
        </div>
      </div>
    </>
