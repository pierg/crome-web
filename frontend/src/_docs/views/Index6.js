  ...
  return (
    <>
      <div className="flex flex-wrap">
        <div className="w-full px-4 md:h-screen md:w-5/12 md:px-10 lg:px-20 flex items-center">
        ...
        <div className="w-full h-full md:w-7/12 md:block md:h-screen flex items-center shadow">
