...
export default function WhatIsReact() {
  return (
    <>
      ...
      <h3 className="text-2xl font-medium mb-2 mt-10">Learn Once, Write Anywhere</h3>
      <p className="leading-extra-relaxed font-light text-base mb-5">
      ...
      <p className="leading-extra-relaxed font-light text-base mb-5">
        ...
        <code className="text-sm font-mono bg-blueGray-200">render()</code> method that
        takes input data and returns what to display. This example uses an XML-like
        syntax called JSX. Input data that is passed into the component can be accessed
        by <code className="text-sm font-mono bg-blueGray-200">render()</code> via{" "}
        <code className="text-sm font-mono bg-blueGray-200">this.props</code>.
      </p>
      <p className="leading-extra-relaxed font-light text-base mb-5">Hello Taylor</p>
      <SyntaxHighlighter
        language="jsx"
