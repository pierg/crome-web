    ...
    <>
      <ul className="mt-8 mb-3 list-disc pl-8">
        ...
        <li className="py-1">
          ...
          >
            {`npm i -E @notus-pro/react@1.0.0 @fortawesome/fontawesome-free@5.15.3 @popperjs/core@2.9.2 @tailwindcss/forms@0.3.2 chart.js@3.1.0 classnames@2.3.1 prop-types@15.7.2 react@17.0.2 react-router@5.2.0 react-router-dom@5.2.0 tailwindcss@2.1.1`}
          </SyntaxHighlighter>
        </li>
        <li className="py-1">
