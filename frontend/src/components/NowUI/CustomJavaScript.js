        ...
        <Container>
          ...
          <Row id="modals">
            <Col md="6">
              ...
              <Button color="info" className="mr-1" onClick={() => setModalMini(true)}>
                <i className="now-ui-icons media-1_button-power"></i> Launch Modal Mini
              </Button>
              <Button
                color="info"
                className="mr-1"
              ...
              <Modal isOpen={modalClassic} toggle={() => setModalClassic(false)}>
            ...
            <Col md="6">
              ...
              <UncontrolledTooltip delay={0} placement="top" target="tooltip605005046">
                Tooltip on top
              </UncontrolledTooltip>
              <Button
                className="btn-tooltip mr-1"
