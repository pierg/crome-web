import "../Custom/ContractContentEditor"
import "../Elements/Checkbox"
import "../Elements/Input"
import "_texts/custom/contracteditorinfo.js"
import "hooks/stringToListConversion.js"
import "react"
import "reactstrap"
import Checkbox
import ContractContentEditor
import contracteditorinfo
import Input
import makeListOf
import ModalFooter }
import React
  ...
  function changeParameter(
    ...
    switch (e.target.name) {
      ...
      case "description":
        ...
        break;
      case "context":
        goal.context.includes(value)
          ? goal.context.splice(goal.context.indexOf(value), 1)
          : goal.context.push(value);
        break;
      case "ltl_value":
  ...
  return (
    <>
      ...
      <div className="modal-body justify-content-center" onKeyPress={handleKeyEvent}>
        ...
        {props.listOfWorldVariables[props.listOfWorldVariables.length - 1].map(
          (prop, key) => (
            <Checkbox
              key={key}
              label={prop}
              name="context"
              checked={goal.context.includes(prop)}
              onChange={(e) => changeParameter(e, false, 0, prop)}
            />
          )
        )}
