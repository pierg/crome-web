...
const props = {
  imageUpload: {
    placeholder: "/static/react/static/media/face-1.dbea4a4c.jpg",
  ...
  progress: { text: "Profile completion", value: 80, color: "pink" },
  saveButton: { color: "dark", children: "Save Change" },
  cancelButton: { color: "red", children: "Cancel", outline: true },
  defaultOpened: 1,
  tabsColor: "pink",
  tabs: [
    {
      ...
      tabContent: [
        {
          ...
          inputs: [
            {
              label: "First Name",
              input: { defaultValue: "Charlie", placeholder: "First Name" },
            },
            {
              label: "Last Name",
              input: { defaultValue: "Bailey", placeholder: "Last Name" },
            },
            {
              label: "I'm",
              select: { items: ["Female", "Male"], placeholder: "Gender" },
            },
            {
              label: "Birth Date",
              select: {
      ...
      tabContent: [
        {
          ...
          table: {
            ...
            body: [
              [
                { image: "/static/react/static/media/visas.251354e9.png" },
                "•••• •••• •••• 8372",
                { radio: { name: "billing-method", defaultChecked: true } },
                { button: { color: "red", size: "sm", children: "delete" } },
              ],
              [
                { image: "/static/react/static/media/mastercard.d0ba8641.png" },
                "•••• •••• •••• 1225",
                { radio: { name: "billing-method" } },
                { button: { color: "red", size: "sm", children: "delete" } },
              ],
            ],
          },
    ...
    },
    {
      ...
      tabContent: [
        ...
        },
        {
          ...
          list: [
            { text: "Notify me via email when logging in", checkbox: {} },
            {
        ...
        },
        {
          ...
          list: [
            ...
            },
            {
              label: "",
              inverted: "true",
              checkbox: { label: "Someone follows me" },
            },
            {
              label: "",
              inverted: "true",
              checkbox: { label: "Someone shares my activty" },
            },
            {
              label: "",
              inverted: "true",
              checkbox: { label: "Someone messages me" },
            },
            {
              label: "",
              inverted: "true",
              checkbox: { label: "Someone adds me to a project" },
            },
            {
              label: "",
              inverted: "true",
              checkbox: { label: "Sales and promotions" },
            },
          ],
        },
        {
          ...
          list: [
            {
              label: "",
              inverted: "true",
              radio: { label: "Daily", name: "notification-frequency" },
            },
            {
              label: "",
              inverted: "true",
              radio: { label: "Weekly", name: "notification-frequency" },
            },
            {
              label: "",
              inverted: "true",
              radio: { label: "Monthly", name: "notification-frequency" },
            },
            {
              label: "",
              inverted: "true",
              radio: { label: "Never", name: "notification-frequency" },
            },
          ],
        },
      ],
