...
export default function CustomCardMini({
  ...
  return (
    <>
      <div onClick={() => onSelectCustomHeader(headerKey, clickable)} className={"relative flex justify-center break-words bg-white rounded-lg mb-6 shadow-lg text-center " + mouseHover}>
        <div className="p-3 ">
