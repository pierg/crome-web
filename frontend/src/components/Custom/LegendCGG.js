...
function LegendCGG() {
    return(
    <fieldset className="relative border w-64 p-2 mt-12 bg-white rounded shadow-md min-w-0 break-words">
        ...
        <div className="flex items-center pl-4 py-1">
            ...
            <span className="ml-4 font-bold uppercase text-blueGray-700">Created goals</span>
        </div>

        <div className="flex items-center pl-4 py-1">
            <div className="box-content bg-white border-emerald-500 h-5 w-10 border-2 rounded-lg"></div>
            <span className="ml-4 font-bold uppercase text-blueGray-700">Initial goals</span>
        </div>
        ...
        <div className="flex items-center pl-4  ">
            ...
            <span className="font-bold ml-4 uppercase text-blueGray-700">Refinement link</span>
        </div>
