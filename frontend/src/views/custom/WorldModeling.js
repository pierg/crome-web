...
import "../../components/Custom/Examples/GetProjects"
import "../../components/Custom/WorldView"
  ...
  render() {
    ...
    return (
      <>
        ...
        />
        <ParentComponent clearWorld={this.clearWorld}>{children}</ParentComponent>
        <Modal
