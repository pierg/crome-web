...
function CardInfoIcon(_ref) {
  ...
  var iconBgColor = {
    ...
    pink: "bg-pink-400",
    "blueGray-gradient": "bg-gradient-to-b from-blueGray-400 to-blueGray-600 bg-blueGray-400",
    ...
    "emerald-gradient": "bg-gradient-to-b from-emerald-400 to-emerald-600 bg-emerald-400",
    "teal-gradient": "bg-gradient-to-b from-teal-400 to-teal-600 bg-teal-400",
    "lightBlue-gradient": "bg-gradient-to-b from-lightBlue-400 to-lightBlue-600 bg-lightBlue-400",
  ...
  var gradientText = gradient ? "-gradient" : "";
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
    className: "relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "px-4 py-5 flex-auto"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full " + iconBgColor[iconColor + gradientText]
