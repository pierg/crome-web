...
function NavbarButton(_ref) {
  ...
  var classes = (0, _classnames.default)("ml-auto cursor-pointer text-xl leading-none px-3 py-1 border border-solid border-blueGray-400 rounded bg-transparent block outline-none focus:outline-none text-blueGray-300", breakpoints[breakpoint], className);
